...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.11.0)", date = "2020-04-23")
public class ExecuteStatementResp implements org.apache.thrift.TBase<ExecuteStatementResp, ExecuteStatementResp._Fields>, java.io.Serializable, Cloneable, Comparable<ExecuteStatementResp> {
  ...
  public java.util.List<java.lang.String> columnsList; // optional
  public java.util.List<java.util.List<java.lang.String>> rowList; // optional
  ...
  public ExecuteStatementResp setColumnsList(java.util.List<java.lang.String> columnsList) {
  ...
  public ExecuteStatementResp setRowList(java.util.List<java.util.List<java.lang.String>> rowList) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                java.util.List<java.lang.String> _elem4;
      ...
      if (incoming.get(1)) {
        {
          ...
          java.util.List<java.lang.String> _elem19;
