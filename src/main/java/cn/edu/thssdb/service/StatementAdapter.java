...
public class StatementAdapter {
    ...
    private QueryTable getQueryTable(String table, WhereCondition wc) {
        ...
        if (wc != null && (wc.tableName.toUpperCase().equals(table.toUpperCase()) || wc.tableName.equals(""))) {
    ...
    private List<Integer> getJoinIndex(String t1, String t2, JoinCondition jc) {
        ...
        if (jc.table1.toUpperCase().equals(t1.toUpperCase()) && jc.table2.toUpperCase().equals(t2.toUpperCase())) {
